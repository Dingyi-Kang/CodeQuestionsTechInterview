## get the character at the certain index of string
...
## if a string is defined as let, no matter what mutant operations you do on it (dropFirst, remove), it wont change. and there is no compile error!!

### remove a character at certain index of the string
...
## there is no single quote in Swift
